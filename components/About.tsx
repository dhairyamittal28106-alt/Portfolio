      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <motion.div
            ...
            className="card-sheen rounded-[2rem] border border-black/5 bg-white/80 p-8 shadow-[0_20px_80px_rgba(15,23,42,0.08)] backdrop-blur dark:border-white/10 dark:bg-white/[0.04] dark:shadow-none md:p-10"
          >
            ...
            <h2 className="mt-6 text-3xl font-semibold tracking-tight text-neutral-950 dark:text-white md:text-5xl">
              Building software with depth, clarity, and real-world intent.
            </h2>

            <p className="mt-6 max-w-3xl text-base leading-8 text-neutral-600 dark:text-neutral-400 md:text-lg">
            ...
            <p className="mt-5 max-w-3xl text-base leading-8 text-neutral-600 dark:text-neutral-400 md:text-lg">
          ...
          >
            {pillars.map((pillar) => (
              <div
                key={pillar.title}
                className="card-sheen hover-lift rounded-[1.75rem] border border-black/5 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(255,245,240,0.94))] p-6 shadow-[0_14px_50px_rgba(15,23,42,0.07)] dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.025))] dark:shadow-none"
              >
